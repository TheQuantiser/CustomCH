...
class FloatingMSSMXSHiggs(MSSMLikeHiggsModel):
    ...
    def doParametersOfInterest(self):
        ...
        ## bound.
        #
        #mssm_scan = mssm_xsec_tools("{CH_BASE}/{PATH}".format(CH_BASE=os.environ.get('CH_BASE', '/path/to/CustomCH'), PATH="HiggsAnalysis/HiggsToTauTau/data/out.mhmax-mu+200-7TeV-nnlo.root"))
